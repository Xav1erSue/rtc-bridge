...
class TestSource(Source):
    ...
    def __init__(self):
        ...
        self.audio_srcpad = Gst.GhostPad.new(
            "audio_src", audiobin.get_static_pad("src")
        )
        self.add_pad(self.audio_srcpad)

        self.video_srcpad = Gst.GhostPad.new(
            "video_src", videobin.get_static_pad("src")
        )
    ...
    def setup_bin(self):
        ...
        self.video_srcpad = Gst.GhostPad.new(
            "video_src", videoqueue.get_static_pad("src")
        )
        self.add_pad(self.video_srcpad)
        ...
        self.audio_srcpad = Gst.GhostPad.new(
            "audio_src", audioqueue.get_static_pad("src")
        )
        self.add_pad(self.audio_srcpad)
